...
for week in weeks:
    ...
    epochs = 80
    # # Training
    train_metrics_path = 'deployment\\TL\\' + str(week) +'_train_metrics.csv'
    loss_path = 'deployment\\TL\\' + str(week) +'_train_loss.csv'
    test_metrics_path = 'deployment\\TL\\' + str(week) +'_test_metrics.csv'
    results_path = 'deployment\\TL\\' + '_results_by_epoch.csv'
    model_path = 'deployment\\TL\\' + str(week) +'_weights.pth'
